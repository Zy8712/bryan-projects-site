...
export default function ExploreCertsLink() {
    return (
        <>
            <div className="w-28 absolute bottom-7 left-2 hidden custom-xl:block">
                <a href="https://bryan-certificates-site.vercel.app/" target="_blank"
                    ...
                    <div className="absolute top-2 -z-30 w-[126px] h-28 rounded-md group-hover:bg-black group-hover:bg-opacity-15"></div>
                </a>
            </div>
        </>
    );
