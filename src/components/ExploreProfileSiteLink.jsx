...
export default function ExploreProfileSite() {
    return (
        <>
            <div className="w-32 absolute bottom-10 right-1 hidden custom-xl:block">
                <a href="https://bryanli.vercel.app/" target="_blank"
                    ...
                    <div className="absolute -top-3 -z-30 w-32 h-32 rounded-md group-hover:bg-black group-hover:bg-opacity-15"></div>
                </a>
            </div>
        </>
    );
